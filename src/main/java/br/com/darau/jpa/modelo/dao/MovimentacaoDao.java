package br.com.darau.jpa.modelo.dao;
...
public class MovimentacaoDao {
    ...
    public List<MediaComData> getMediaDiariaDasMovimentacoes() {
        String jpql = "select new br.com.darau.jpa.modelo.MediaComData(avg(m.valor), day(m.data), month(m.data)) from Movimentacao m "
