...
import br.com.darau.jpa.modelo.Categoria;
...
public class TestaRelacionamentoMC {
    public static void main(String[] args) {
        EntityManagerFactory gettingd = Persistence.createEntityManagerFactory("contas");
        EntityManager em = gettingd.createEntityManager();
